...
def parse_arguments():
    ...
    # 必需参数：两个表达式
    parser.add_argument('--expr1', type=str, required=True, help='第一个数学表达式')
    parser.add_argument('--expr2', type=str, required=True, help='第二个数学表达式')
    
    # API相关参数
    parser.add_argument('--base_url', type=str, 
                        default=os.environ.get('LLM_API_BASE_URL', 'https://api.openai.com/v1'),
    ...
    parser.add_argument('--model', type=str, 
                        default=os.environ.get('LLM_MODEL', 'gpt-3.5-turbo'),
